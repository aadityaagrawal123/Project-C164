AFRAME.registerComponent("bullets", {
  ...
  shootBullet: function () {
    window.addEventListener("keydown", (e) => {
      if (e.key === "z") {
        ...
        var bulletColorList = ["green","#337dff","red","orange","pink","#00a0ff","#5c00ff","#00ff62","#Fc00ff","#A900ff"] 
        var bulletcolor = bulletColorList[Math.floor(Math.random() * 10)];

        bullet.setAttribute("material", "color", `${bulletcolor}`);
  ...
  removeBullet: function (e) {
    ...
    var bulletcolorlist = ["green","#337dff","red","orange","pink","#00a0ff","#5c00ff","#00ff62","#Fc00ff","#A900ff"] 
    var bulletColor = `${(element.getAttribute("material"))["color"]}`
    var splashColor = ((bulletcolorlist.indexOf(bulletColor)) + 1)

    paint.setAttribute("material", {
      opacity: 1,
      transparent: true,
      src: "./images/paint splash-0" + splashColor + ".png"
    });
